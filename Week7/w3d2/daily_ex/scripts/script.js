...
//     let onlyHonda = carInventory.find((carInventory)=>carInventory.car_make===`Honda`)
//     return console.log(`This is a ${onlyHonda.car_make} ${onlyHonda.car_model} from ${onlyHonda.car_year}.`)
